              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @if($todo->status == 0)
                    <td><i class="fas fa-circle text-secondary"></i>&nbsp;&nbsp;ยังไม่ได้ทำ</td>
                    @elseif($todo->status == 1)
                    <td><i class="fas fa-circle text-primary"></i>&nbsp;&nbsp;กำลังทำ</td>
                    @elseif($todo->status == 2)
                    <td><i class="fas fa-circle text-success"></i>&nbsp;&nbsp;ทำเสร็จแล้ว</td>
                    @endif
                    <td class="fw-light">{{$todo->updated_at}}</td>
                    <td>
